...
//		contentPane = new JPanel();
	...
	private void init() {
		...
		chucvu_jlabel.setBounds(307, 30, 138, 34);
		...
		luong_jlabel.setBounds(317, 71, 138, 34);
		panel_1.add(luong_jlabel);

		luong_jtfiel = new JTextField();
		luong_jtfiel.setColumns(10);
		luong_jtfiel.setBounds(462, 76, 154, 30);
		...
		capnnhat_jbutton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(nhanVienModel!=null) {
					JOptionPane.showMessageDialog(null, "Cập nhât thành công");
				}
				else {
		...
		nhanvien_comboBox.setBounds(467, 30, 112, 30);
	...
	public void hienThiThongTinNhanVien() {
		...
		ngayvaolam_jtfiel.setText(ngay + "");

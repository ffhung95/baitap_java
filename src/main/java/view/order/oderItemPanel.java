...
public class oderItemPanel extends javax.swing.JPanel {

	oderItem orderItem;
	ImageManager im = new ImageManager();
	DecimalFormat formatter = new DecimalFormat("###,###,###");

	public oderItemPanel(oderItem o) {
		initComponents();
	...
	public void render() {
		hangHoa food = orderItem.getFoodItem(), topping = orderItem.getToppingItem();
		spnQuantity.setValue(orderItem.getSoluong());
		lbFoodName.setText(food.getTenHangHoa());
		if (food.getIdmaloaihang() != 2) {
			lbToppingName.setText("");
		} else if (topping == null) {
			lbToppingName.setText("");
		} else {
			lbToppingName.setText(topping.getTenHangHoa());
		}
		lbPrice.setText(orderItem.getWaterPrice() + orderItem.getToppingPrice() + "");
		String urlImage = orderItem.getFoodItem().getAnhHangHoa();
	...
	private void initComponents() {
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addComponent(lbIcon, javax.swing.GroupLayout.Alignment.TRAILING,
		...
		jPanel3Layout.setHorizontalGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel3Layout.createSequentialGroup().addGap(17, 17, 17).addGroup(jPanel3Layout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(jPanel3Layout.createSequentialGroup().addComponent(lbFoodName).addGap(0, 88,
								Short.MAX_VALUE))
						.addGroup(jPanel3Layout.createSequentialGroup().addComponent(lbToppingName)
		...
		jPanel3Layout.setVerticalGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel3Layout.createSequentialGroup().addContainerGap().addComponent(lbFoodName)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 23, Short.MAX_VALUE)
						.addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(lbToppingName).addComponent(lbPrice).addComponent(jLabel5))
						.addContainerGap()));

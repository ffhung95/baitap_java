...
public class themDonHangView extends javax.swing.JFrame implements cuaSoView{

    DefaultComboBoxModel<table> tbComboBoxModel = new DefaultComboBoxModel<>();
    DefaultComboBoxModel<nhanVienModel> nvComboBoxModel = new DefaultComboBoxModel<>();

    public themDonHangView() {
        initComponents();
    ...
    public DefaultComboBoxModel<nhanVienModel> getnvComboBoxModel() {
        return nvComboBoxModel;
    }

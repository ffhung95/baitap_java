...
public class toppingView extends javax.swing.JFrame {

    loaiHangHoaRepository foodItemDao = new loaiHangHoaRepository();
    ...
    public JComboBox<hangHoa> getCboTopping() {
        return cboTopping;
    }
    ...
    private javax.swing.JComboBox<hangHoa> cboTopping;
